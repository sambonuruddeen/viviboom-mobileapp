/**
 * With reference to npm package expo image manipulator: https://github.com/brunon80/expo-image-crop
 */
    ...
    async onConvertImageToEditableSize() {
        ...
        Image.getSize(rawUri, async (imgW, imgH) => {
            ...
            if (this.props.isVisible) {
                Toast.show({ text1: 'This image cannot be edited.', type: 'error' });
                this.onToggleModal();
            }
        })
    }
            ...
            >
                ...
                <View style={{ flex: 1, backgroundColor: 'black', width: Dimensions.get('window').width }}>
                    <ScrollView
                        ...
                        contentContainerStyle={{ backgroundColor: 'black', justifyContent: 'center', height: originalHeight }}
                        maximumZoomScale={5}
