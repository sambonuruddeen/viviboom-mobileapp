...
interface BadgeProjectTabProps {
  badge: Badge;
  scrollY: Animated.Value;
  onScrollEnd: () => void;
}

const BadgeProjectTab = forwardRef<ScrollView, BadgeProjectTabProps>(({ badge, scrollY, onScrollEnd }, ref) => {
  ...
  const fetchProjects = useCallback(
    ...
    [isFetchingProjects, isEndOfProjects, authToken, projects, badge?.id, selectedFilterKey],
  );
...
export default BadgeProjectTab;
