...
import { KeyboardCompatibleView, useTheme, vh } from 'stream-chat-expo';
...
export const BottomSheetOverlay = (props: BottomSheetOverlayProps) => {
  ...
  const onPan = useAnimatedGestureHandler<PanGestureHandlerGestureEvent>({
    onActive: (evt) => {
      ...
      overlayOpacity.value = interpolate(translateY.value, [0, viewHeight.value / 2], [1, 0.75], Extrapolate.CLAMP);
    },
    onFinish: (evt) => {
