...
>(
  ...
  return (
    <TouchableOpacity disabled={disabled} onPress={sendMessage} style={[sendButton]} testID="send-button">
...
>(
  ...
  const { disabled: prevDisabled, giphyActive: prevGiphyActive, sendMessage: prevSendMessage } = prevProps;
  const { disabled: nextDisabled, giphyActive: nextGiphyActive, sendMessage: nextSendMessage } = nextProps;
...
const MemoizedNewDirectMessagingSendButton = React.memo(SendButtonWithContext, areEqual) as typeof SendButtonWithContext;
...
export const NewDirectMessagingSendButton = (props: SendButtonProps<StreamChatGenerics>) => {
  ...
  return <MemoizedNewDirectMessagingSendButton<StreamChatGenerics> {...{ giphyActive, sendMessage }} {...props} {...{ disabled: props.disabled || false }} />;
};
