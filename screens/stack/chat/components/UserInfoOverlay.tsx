...
import { Avatar, CircleClose, MessageIcon, User, UserMinus, useChatContext as useStreamChatContext, useTheme, vh } from 'stream-chat-expo';
...
export const UserInfoOverlay = (props: UserInfoOverlayProps) => {
  ...
  const { client } = useStreamChatContext<StreamChatGenerics>();
  ...
  const self = channel ? Object.values(channel.state.members).find((channelMember) => channelMember.user?.id === client.user?.id) : undefined;
                    ...
                    <>
                      <View style={styles.detailsContainer}>
                        ...
                        <Text style={[styles.channelStatus, { color: grey }]}>
                          {member.user?.online ? 'Online' : `Last Seen ${DateTime.fromISO(member.user?.last_active).toRelative()}`}
                        </Text>
                      ...
                      {channelCreatorId === chatClient?.user?.id ? (
                        ...
                        >
                          ...
                          >
                            ...
                            <Text style={[styles.rowText, { color: accent_red }]}>Remove From Group</Text>
                          </View>
                        </TapGestureHandler>
                      ) : null}
                      <TapGestureHandler
