...
export const isAddMemberBottomSheetData = (data: BottomSheetOverlayData): data is Pick<ChannelContextValue<StreamChatGenerics>, 'channel'> => 'channel' in data;
...
export const BottomSheetOverlayProvider = ({
  ...
  return (
    <BottomSheetOverlayContext.Provider value={bottomSheetOverlayContext as BottomSheetOverlayContextValue}>{children}</BottomSheetOverlayContext.Provider>
  );
};

export const useBottomSheetOverlayContext = () => useContext(BottomSheetOverlayContext) as unknown as BottomSheetOverlayContextValue;
