...
type GroupChannelDetailsScreenNavigationProp = StackNavigationProp<ChatRootStackParamList, 'GroupChannelDetailsScreen'>;

export type UserInfoOverlayData = Partial<Pick<ChannelContextValue<StreamChatGenerics>, 'channel'>> & {
...
export const UserInfoOverlayProvider: React.FC<{
  ...
  return <UserInfoOverlayContext.Provider value={userInfoOverlayContext as UserInfoOverlayContextValue}>{children}</UserInfoOverlayContext.Provider>;
};

export const useUserInfoOverlayContext = () => useContext(UserInfoOverlayContext) as unknown as UserInfoOverlayContextValue;
