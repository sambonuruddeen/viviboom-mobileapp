...
import { FileIcon, ThemeProvider, getFileSizeDisplayText, useTheme } from 'stream-chat-expo';
...
export default function ChannelFilesScreen({
...
}: ChatRootStackScreenProps<'ChannelFilesScreen'>) {
  ...
  useEffect(() => {
    ...
    messages.forEach((message) => {
      const month = DateTime.fromISO(message?.created_at).toFormat('MMM YYYY');
...
const EmptyListComponent = () => {
  ...
  return (
    <View style={styles.emptyContainer}>
      ...
      <Text style={[styles.noFilesDetails, { color: grey }]}>Files sent on this chat will appear here.</Text>
    </View>
  );
};
