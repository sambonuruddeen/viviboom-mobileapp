...
export default function ChannelPinnedMessagesScreen({
...
}: ChatRootStackScreenProps<'ChannelPinnedMessagesScreen'>) {
  const {
    theme: {
      colors: { white_snow },
    },
  ...
  return (
    ...
    >
      ...
      <MessageSearchList EmptySearchIndicator={EmptyListComponent} loading={loading} loadMore={loadMore} messages={messages} />
    </View>
  );
}
...
const EmptyListComponent = () => {
  ...
  return (
    <View style={styles.emptyContainer}>
      ...
      <Text style={[styles.noFilesDetails, { color: grey }]}>Long-press an important message and choose Pin to conversation.</Text>
    </View>
  );
};
