...
export default function NewGroupChannelAssignNameScreen({ navigation }: ChatRootStackScreenProps<'NewGroupChannelAssignNameScreen'>) {
  ...
  return (
    <View style={styles.container}>
      <ScreenHeader RightContent={() => <ConfirmButton disabled={!groupName} onPress={onConfirm} />} style={styles.header} titleText="Name of Group Chat" />
      <View style={styles.container}>
        <View
          style={[
        ...
        {selectedUsers.length >= 0 && <UserSearchResults groupedAlphabetically={false} removeOnPressOnly results={selectedUsers} showOnlineStatus={false} />}
      </View>
    </View>
  );
}
